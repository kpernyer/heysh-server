#!/usr/bin/env python3
"""Simplified Domain Bootstrap Worker for Temporal workflows."""
...
# Import workflows - ONLY the domain bootstrap workflow
...
async def run_domain_bootstrap_worker():
    ...
    logger.info("🚀 Starting Domain Bootstrap Worker...")
    ...
    try:
        ...
        # Create worker with ONLY the domain bootstrap workflow
        worker = Worker(
            client,
