#!/usr/bin/env python3
"""Isolated Domain Bootstrap Worker - No problematic imports."""
...
async def run_domain_bootstrap_worker():
    """Run the isolated domain bootstrap worker."""
    logger.info("🚀 Starting Isolated Domain Bootstrap Worker...")
    ...
    try:
        ...
        worker = Worker(
            ...
            workflows=[DomainBootstrapWorkflowIsolated],
            activities=[
                research_domain_activity,
                analyze_research_results_activity,
                generate_domain_config_activity,
        ...
        logger.info("📋 Registered workflows: DomainBootstrapWorkflowIsolated")
