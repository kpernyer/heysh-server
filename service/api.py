...
from service.graphql import schema
from service.graphql.resolvers import resolver
...
from service.routes_workflows import router as workflows_router
from service.routes_workflows import set_temporal_client
from service.version import get_backend_info
...
@app.get("/api/v1/info")
async def backend_info() -> dict[str, str | None]:
